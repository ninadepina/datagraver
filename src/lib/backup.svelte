<!-- <script>
    ...
    const createChart = () => {
        ...
        svg.selectAll('.barLeft')
            ...
            .style('fill', (d) => alternateColor(d.year, true));
        // prettier-ignore
        svg.selectAll('.barRight')
            ...
            .attr('height', yScale.bandwidth())
            .style('fill', (d) => alternateColor(d.year, false));
        ...
        // svg.append('text')
        //     .attr('transform', `translate(${(3 * width) / 4}, -10)`)
        //     .style('text-anchor', 'middle')
        //     .text('Right Side');
    };
</script>
    ...
    const createChart = () => {
        ...
        svg.selectAll('.barLeft')
            ...
            .style('fill', (d) => {
                ...
                // console.log('Left Bar - Year:', d.year, 'Cumulative Seats:', cumulativeSeats);
